...
| ID | SPEC | Status |
|----|------|--------|
| [SPEC-010](SPEC-010-configuracao-deepseek.md) | **Principal:** Configuração do Cliente DeepSeek | ✅ Concluído |
|   ↳ [SPEC-011](SPEC-011-configuracao-ambiente.md) | Subspec: Configuração de Ambiente e Segurança | ✅ Concluído |
|   ↳ [SPEC-012](SPEC-012-catalogo-alimentos.md) | Subspec: Catálogo de Alimentos (FoodCatalog) | ✅ Concluído |
|   ↳ [SPEC-013](SPEC-013-logs-observabilidade.md) | Subspec: Logs e Observabilidade Básica | ✅ Concluído |

### Família 020 — Pipeline de Processamento

| ID | SPEC | Status |
|----|------|--------|
| [SPEC-020](SPEC-020-extracao-nl-json.md) | **Principal:** Serviço de Extração NL→JSON | ✅ Concluído |
|   ↳ [SPEC-021](SPEC-021-expansao-restricoes.md) | Subspec: Expansão de Restrições e Condições Especiais | ✅ Concluído |
|   ↳ [SPEC-022](SPEC-022-geracao-planos-ia.md) | Subspec: Serviço de Geração de Planos via IA | ✅ Concluído |
|   ↳ [SPEC-023](SPEC-023-pipeline-validacao.md) | Subspec: Pipeline de Validação Pós-Geração | ✅ Concluído |
|   ↳ [SPEC-024](SPEC-024-orquestrador.md) | Subspec: Orquestrador (UseCase) | ✅ Concluído |
|   ↳ [SPEC-025](SPEC-025-endpoint-geracao.md) | Subspec: Endpoint de Geração | ✅ Concluído |
|   ↳ [SPEC-026](SPEC-026-tratamento-erros.md) | Subspec: Tratamento de Erros e Resiliência | ✅ Concluído |

### Família 030 — Frontend

| ID | SPEC | Status |
|----|------|--------|
| [SPEC-030](SPEC-030-frontend-input.md) | **Principal:** Frontend — Página de Input | ✅ Concluído |
|   ↳ [SPEC-031](SPEC-031-frontend-resultados.md) | Subspec: Frontend — Tela de Resultados | ✅ Concluído |
...
4. **Nova SPEC Principal:** ID múltiplo de 10 (ex: `060`). Adicionar como nova família na fase correta.
5. **Nova Subspec:** ID sequencial dentro da dezena (ex: `032` para família `030`). Adicionar com `↳` abaixo da Principal.
